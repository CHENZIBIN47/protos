...
func request_Blog_SearchBlog_0(ctx context.Context, marshaler runtime.Marshaler, client BlogClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SearchBlogRequest
	...
	msg, err := client.SearchBlog(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_Blog_SearchBlog_0(ctx context.Context, marshaler runtime.Marshaler, server BlogServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq SearchBlogRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.SearchBlog(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterBlogHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BlogServer) error {
	...
	mux.Handle("POST", pattern_Blog_SearchBlog_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Blog_SearchBlog_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Blog_SearchBlog_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBlogHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BlogClient) error {
	...
	mux.Handle("POST", pattern_Blog_SearchBlog_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Blog_SearchBlog_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Blog_SearchBlog_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "blog", "searchBlog"}, "", runtime.AssumeColonVerbOpt(true)))
)

var (
	forward_Blog_SearchBlog_0 = runtime.ForwardResponseMessage
)
